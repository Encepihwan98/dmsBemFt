...
class SuratMasukController extends Controller
{
    ...
    public function data(){
        $data = Surat::where('jenis_surat','surat masuk');
    ...
    {
        return view('admin.surat.surat_masuk.form');
    }
    ...
    public function store(Request $request)
    {
         ...
         $fileName_save = 'storage/uploads/surat/img-' . time() . '.' . request()->file->getClientOriginalExtension(); //simpan ke db
    ...
    public function edit($id)
    {
        ...
        return view('admin.surat.surat_masuk.edit', $data);
    }
