        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <a href="{{route('surat.surat_masuk.add')}}" class="btn btn-primary ms-5">Add</a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function isi() {
        $('#myTable').DataTable({
            ...
            responseive: true,
            ajax: {
                url: "{{route('surat.surat_masuk.data')}}",
                "type": "GET"
            },
            columns: [{
