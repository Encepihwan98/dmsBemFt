        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <a href="{{route('lpj.add')}}" class="btn btn-primary ms-5">Add</a>
                    </div>
                </div>
            </div>
            ...
            columns: [{
                ...
                },
                {
                    render: function(data, type, row) {
                        return '<ul class="table-controls"> <li><a href="/lpj/edit/' + row.id + '" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle text-primary"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path> <polyline points="22 4 12 14.01 9 11.01"></polyline></svg></a></li><li><a href="/lpj/destroy/' + row.id +
