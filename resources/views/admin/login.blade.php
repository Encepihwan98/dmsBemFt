...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('assets/assets/css/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('assets/assets/css/forms/switches.css')}}">
</head>
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Sign In</h1>
                        <p class="">Documen Manajemen System BEM FT UNLA</p>
                        ...
                        @csrf
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    <label for="username" class="left">EMAIL</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="email" name="email" type="email" class="form-control" placeholder="e.g John_Doe@gmail.com">
                                </div>
    ...
    <script src="{{url('assets/assets/js/authentication/form-2.js')}}"></script>
