...
<head>
    ...
    <link href="{{url('assets/assets/css/tables/table-basic.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{url('assets/plugins/font-icons/fontawesome/css/regular.css')}}">
    <link rel="stylesheet" href="{{url('assets/plugins/font-icons/fontawesome/css/fontawesome.css')}}">
...
<body>
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="{{url('assets/assets/img/90x90.jpg')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="index.html" class="nav-link"> DMS BEM FT UNLA</a>
                </li>
            </ul>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <img src="{{url('assets/assets/img/90x90.jpg')}}" alt="avatar">
                    </a>
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('dasboard')}}">Dashboard</a></li>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                            <li class="active">
                                <a href="{{route('surat.surat_masuk')}}"> Surat Masuk </a>
                            </li>
                            <li>
                                <a href="{{route('surat.surat_keluar')}}"> Surat Keluar </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{route('lpj')}}"> LPJ </a>
                            </li>
                            <li>
                                <a href="{{route('kegiatan')}}"> Kalender Kegiatan </a>
                            </li>
                        </ul>
                    </li>
    ...
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script src="{{url('assets/plugins/font-icons/feather/feather.min.js')}}"></script>
